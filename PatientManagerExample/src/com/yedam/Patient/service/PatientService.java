...
public class PatientService {
	...
	public void getPatientList() {
		...
		System.out.println("─────────────────────────────전체 환자 조회──────────────────────────────");
		for(int i=0; i<list.size(); i++) {
			System.out.println("차트     번호: " + list.get(i).getPtId());
			System.out.println();
			System.out.println("환자    이름 : " + list.get(i).getPtName());
			System.out.println();
			System.out.println("담당 사원번호 : " + list.get(i).getPtManager());
			System.out.println();
			System.out.println("통증    부위 : " + list.get(i).getPtPain());
			System.out.println();
			System.out.println("연   락  처 : " + list.get(i).getPtPhone());
			System.out.println();
			System.out.println("생 년 월  일 : " + list.get(i).getPtBirth());
			System.out.println();
			System.out.println("방   문  일 : " + list.get(i).getPtVisit());
			System.out.println();
			System.out.println("직       업 : " + list.get(i).getPtJob());
			System.out.println();
			System.out.println("성       별 : " + list.get(i).getPtSex());
			System.out.println();
			System.out.println("진   단   명 : " + list.get(i).getPtDx());
			System.out.println("─────────────────────────────────────────────────────────────────────");
		}
	}
	...
	public void getPatinet() {
		...
		System.out.println("조회한 환자 결과입니다.");
		System.out.println();
...
//	//환자 정보 수정-연락처 수정
	public void updatePt() {
		...
		pt.setPtId(Integer.parseInt(sc.nextLine()));
		System.out.println("변경된 진단명을 입력하세요.");
		pt.setPtDx(sc.nextLine());
