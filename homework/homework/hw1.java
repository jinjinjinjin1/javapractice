...
public class hw1 {
	...
	/*문제4) 아래와 같이 변수가 초기화되어있을 경우 결과값을 저장할
			변수의 타입을 지정하고 값을 변수값을 출력하세요.*/
			byte a = 35;	
			byte b = 25;
			int c = 463;
			long d = 1000L;
		...
		int value12 = intValue1 + intValue2; //27
		String value123 = value12+"8"; //278
		float floatValue4 = intValue4; //10.0
		System.out.println(charValue+value123+strValue+floatValue4);
	    ...
	    //힌트) 곱하기 연산자 (*), 나누기 연산자( / ) 와 빼기 연산자 ( - ) 를 이용하세요. */
		    ...
		    System.out.println((four*five)-(eight-five));
